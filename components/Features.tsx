    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Features"
                    heading="Everything you need for successful events"
                    description="From creating events to managing attendees, our platform provides all the tools you need to host memorable events."
                />
